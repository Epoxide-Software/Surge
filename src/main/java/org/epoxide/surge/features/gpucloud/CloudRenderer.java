 ...
 * advantage of the GPU by uploading vertex data to the GPU to be reused when rendering clouds,
 * which provides significant performance benefits. In testing, this cloud renderer accounted
 * for ~0.48% of the gameRender time, compared to vanilla's ~10%. This will allow players to
 * have clouds enabled, and not experience huge performance penalties.
 *
 * @author Zaggy1024
 */
...
public class CloudRenderer extends IRenderHandler implements IResourceManagerReloadListener {
    ...
    public void render (float partialTicks, WorldClient world, Minecraft mc) {
        ...
        final double totalOffset = this.renderGlobal.cloudTickCounter + partialTicks;
