...
public class Mappings {
    ...
    public static final Mapping METHOD_LOAD_SPRITE_FRAMES = new Mapping("loadSpriteFrames", "(Lnet/minecraft/client/resources/IResource;I)V", CLASS_TEXTURE_ATLAS_SPRITE, false);
