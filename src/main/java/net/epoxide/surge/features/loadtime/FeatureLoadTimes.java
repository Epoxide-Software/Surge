...
public class FeatureLoadTimes extends Feature {
    ...
    private void transformSendEventToModContainerPost (MethodNode method) {
        ...
        newInstr.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "net/epoxide/surge/features/analysis/FeatureLoadTimes", "registerLoadingTime", "(Lnet/minecraftforge/fml/common/ModContainer;Lnet/minecraftforge/fml/common/event/FMLEvent;JJ)V", false));
        newInstr.add(new LabelNode());
